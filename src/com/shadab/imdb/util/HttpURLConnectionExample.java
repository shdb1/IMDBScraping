...
public class HttpURLConnectionExample {
	...
	private static final String GET_URL = "https://v2.sg.media-imdb.com/suggests/h/hum_dil_de_chuke_sanam.json";
	...
	private static void sendGET() throws IOException {
		...
		if (responseCode == HttpURLConnection.HTTP_OK) { // success
			...
			String id = imdb.getD().get(0).getId();
		
			System.out.println("newwwwwwwwwww:"+responsess);
